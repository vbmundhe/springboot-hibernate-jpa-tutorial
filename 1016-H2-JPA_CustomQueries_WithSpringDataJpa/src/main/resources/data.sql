...
insert into student(id,name,passport_id) values(20001,'VBM',40001);
insert into student(id,name,passport_id) values(20002,'NIl',40002);
insert into student(id,name,passport_id) values(20003,'Ram',40003);

insert into COURSE_STUDENT(student_id, course_id) values (20001,10001);
insert into COURSE_STUDENT(student_id, course_id) values (20002,10001);
insert into COURSE_STUDENT(student_id, course_id) values (20003,10001);
insert into COURSE_STUDENT(student_id, course_id) values (20001,10003);
